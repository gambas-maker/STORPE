...
class SportOddOneDay < ApplicationRecord
  ...
  # 2664 = France, 2790 = Angleterre, 2833 = Espagne, 2857 = Italie, 2755 = Allemagne, 2771 = Champions League, 2777 = Europa League, 1422 = Nations League, Bottola Pro = 925, CAN = 1073, World Cup South-Am-Qualif = 1252, World Cup - Qualification Europe = 3079, Women LDC = 3026, Coupe de France = 3081, FA Cup = 2791
